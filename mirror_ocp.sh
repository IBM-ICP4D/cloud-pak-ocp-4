...
begin_banner "Top level" "create an OCP mirror registry"
	...
	export MY_REGISTRY_DOMAIN="${REGISTRY_DOMAIN-chenjfocp.ibm.com}"
	export MY_REGISTRY_SERVER="${REGISTRY_SERVER-registry.$MY_REGISTRY_DOMAIN}"
	...
	export MY_OCP_RELEASE_MAIN_VERSION="${OCP_RELEASE_MAIN_VERSION-4.8}"
	...
	export MY_MIRROR_DIR="${MIRROR_DIR-/ocp4_downloads}"
